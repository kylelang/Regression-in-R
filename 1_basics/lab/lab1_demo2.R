...
getwd()
setwd("E:/teaching/utrecht/winter_school/reg_in_r/Regression-in-R/1_basics/lab") # Let's all set our working directory to the correct place
...
out4.2 <- update(out4, ". ~ . - hp")
summary(out4.2)

out4.3 <- update(out4, ". ~ . - wt")
summary(out4.3)
