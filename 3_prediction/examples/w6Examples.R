...
install.packages(c("e1071"), repos = "http://cloud.r-project.org")
...
piDat <- data.frame(bmi = testDat$bmi,
                    predict(out1, newdata = testDat, interval = "prediction")
                    )
