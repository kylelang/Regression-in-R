...
gg0(x = x, y = trans(x, e = 0, d = 1), points = FALSE) +
    geom_line() +
    xlab("X") +
    ylab("Density")
@ 
...
gg0(x = x, y = trans(x, e = 0, d = 1.5), points = FALSE) +
    geom_line() +
    xlab("X") +
    ylab("Density")
...
gg0(x = x, y = trans(x, e = 0, d = 0.5), points = FALSE) +
    geom_line() +
    xlab("X") +
    ylab("Density")
@ 
...
<<echo = FALSE>>=
p1 <- gg0(x = c(1 : n), y = dffits(out1))

p1 + geom_hline(yintercept = c(-2 * sqrt(2 / n), 2 * sqrt(2 / n)), 
                colour = "red") +
    xlab("Index") +
    ylab("DFFITS")
@ 
